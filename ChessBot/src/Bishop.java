...
public class Bishop implements Piece
{
    ...
    /**
     * @param xPos
     *            the xPosition of the piece
     * @param yPos
     *            the yPosition of the piece
     * @param color
     *            the color of the piece A constructor for a bishop,
     *            instantiates fields
     */
                ...
                if ( b.check( new Location( tempX, tempY ) ) == false )
                {
                    for ( int i = 0; i < pieces.size(); i++ )
                    {
                            ...
                            && pieces.get( i ).getColor() != pieces.get( index ).getColor() )
                        {
                            ...
                            nextPos
                                .add( new Bishop( tempX, tempY, pieces.get( index ).getColor() ) );
                            ans.add( new Board( nextPos ) );
                        }
                    }
                    break;
